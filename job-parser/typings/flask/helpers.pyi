...
def get_flashed_messages(with_categories=..., category_filter=...):
...
def send_file(filename_or_fp, mimetype=..., as_attachment=..., attachment_filename=..., add_etags=..., cache_timeout=..., conditional=..., last_modified=...):
