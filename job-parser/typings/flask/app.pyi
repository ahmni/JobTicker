...
class Flask(_PackageBoundObject):
    ...
    def test_client(self, use_cookies=..., **kwargs):
    ...
    @setupmethod
    def add_url_rule(self, rule, endpoint=..., view_func=..., provide_automatic_options=..., **options):
    ...
    @setupmethod
    def add_template_filter(self, f, name=...):
    ...
    @setupmethod
    def add_template_global(self, f, name=...):
    ...
    def finalize_request(self, rv, from_error_handler=...):
